...
public class DesignerNewOfferEmail implements EmailTemplate {
	 ...
	 */
	public DesignerNewOfferEmail(String __firstName, String __link) throws URISyntaxException, IOException {
		super();
	...
	public Map<String, File> getTemplate() {
		...
		_mapTemplate.put("img_01_thanks.jpg", new File(this.template, "img_01_thanks.jpg"));
	...
	public void loadTemplate() throws URISyntaxException, IOException {
		this.template = new File(
				this.getClass().getClassLoader().getResource("/email-template/designer-offer").toURI());
	}
