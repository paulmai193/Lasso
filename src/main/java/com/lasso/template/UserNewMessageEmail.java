 ...
 * @author Paul Mai
 */
public class UserNewMessageEmail extends BasicEmail implements EmailTemplate {
	 ...
	 */
	public UserNewMessageEmail(String __firstName, String __link, Map<String, String> __mapConfig)
