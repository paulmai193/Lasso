...
public class DesignerCongratEmail implements EmailTemplate {
	 ...
	 */
	public DesignerCongratEmail(String __firstName, String __link) throws URISyntaxException, IOException {
		super();
	...
	public Map<String, File> getTemplate() {
		...
		_mapTemplate.put("img_01_congratulation.jpg", new File(this.template, "img_01_congratulation.jpg"));
		_mapTemplate.put("title_1_congratulation.jpg", new File(this.template, "title_1_congratulation.jpg"));
		_mapTemplate.put("img_02_congratulation.jpg", new File(this.template, "img_02_congratulation.jpg"));
	...
	public void loadTemplate() throws URISyntaxException, IOException {
		this.template = new File(
				this.getClass().getClassLoader().getResource("/email-template/designer-congratulations").toURI());
	}
