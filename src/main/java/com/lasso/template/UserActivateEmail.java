 ...
 * @author Paul Mai
 */
public class UserActivateEmail extends BasicEmail implements EmailTemplate {
	...
	public Map<String, File> getTemplate() {
		...
		_mapTemplate.put("bt1.png", new File(this.template, "bt1.png"));
