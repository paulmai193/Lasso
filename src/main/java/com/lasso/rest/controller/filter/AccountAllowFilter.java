...
public class AccountAllowFilter implements ContainerRequestFilter {
	 ...
	 * Check permissions.
	 *
	 * @param __allowedStatus the allowed status
	 * @param __statusMustCheck the status must check
	 * @param __allowedRoles the allowed roles
	 * @param __roleMustCheck the role must check
